...
/*
    ...
    @run main LocaleInvariantSerializationTest
*/
/*
 ...
 */
public class LocaleInvariantSerializationTest extends IntlTest {
    public static void main(String[] args) throws Exception {
        if (args.length == 1 && args[0].equals("prepTest")) {
            prepTest();
        } else {
            new LocaleInvariantSerializationTest().run(args);
        }
    }
    ...
    private ObjectInputStream getStream(String lang) {
        try {
            final File f = new File(System.getProperty("test.src", "."), "LocaleInvariantSerialization_"+lang);
    ...
    private static void outputLocale(String lang) {
        try {
            ObjectOutputStream out = new ObjectOutputStream(
                    new FileOutputStream("LocaleInvariantSerialization_"+lang));
