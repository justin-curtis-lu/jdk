...
* @test
* @bug 8174722
* @summary Ensure DecimalFormat correctly rounds when formatting doubles
*          less than abs(1) when the fractional digits in the pattern is less
*          than the amount of leading zeros in the decimal string (converted
*          from the floating-point value).
* @run junit CheckUnderflowToZero
*/
...
public class CheckUnderflowToZero {
    ...
    // General test for variety of values against all the modes
    @ParameterizedTest
    ...
    // Ensure arithmetic exception is thrown for underflow to zero values
    @Test
    public void testUnnecessary() {
        DecimalFormat df = new DecimalFormat("0.0");
        df.setRoundingMode(RoundingMode.UNNECESSARY);
        assertThrows(ArithmeticException.class, () -> df.format(0.00001));
    }
