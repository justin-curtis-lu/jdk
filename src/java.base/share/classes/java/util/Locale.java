 ...
 * Environment version 1.7. That is, a length constraint was not imposed on any of
 * the input parameters. Similarly, the same is largely true for the {@link
 * #toString()} method. This is done to ensure behavioral compatibility, and allows
 * for apps to continue using {@code Locale} objects as they were.
