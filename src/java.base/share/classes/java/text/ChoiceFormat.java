...
public class ChoiceFormat extends NumberFormat {
    ...
    /**
     * Parses a Number from the input text. The value returned is the {@code limit}
     * corresponding to the {@code format} which has the greatest overlap with
     * the input text. In the case where multiple {@code formats} match the text
     * equivalently in strength, the first matching {@code limit} is returned.
     * If there is no match, {@code Double.NaN} is returned.
     * <p>For example,
     * {@snippet lang=java :
